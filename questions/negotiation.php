...
<html>
    ...
    <header>
        ...
        <!-- Pregunta 2 -->
        <div class="panel panel-default">
        <div class="panel-heading">&nbsp;FI.3. ¿Tiene usted o está usted involucrada en algún negocio?</div>
				  <div class="panel-body">
                  <div class="hr-line-dashed"></div>
                                <div class="form-group row"><label class="col-sm-2 col-form-label"><br/>
                                    <small class="text-navy"></small></label>
                                    <div class="col-sm-10">
                                        <form action = "" method ="post">
                                        <div><label> <input type="radio" value="si" id="optionsRadios3" name="optionsRadiosf2" > Sí </label></div>
            ...
            <!-- Aceptar/Cancelar -->
				    ...
				    <a class="hide-links" href="filter3.php">
